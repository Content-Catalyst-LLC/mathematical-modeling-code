...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("calibration-data", "Calibration Data", "data review", 96, "active", "2026-06-15", "Data sources, preprocessing, exclusions, and measurement limits should be preserved."),
        CanvasCard("residuals", "Residuals", "diagnostics", 95, "active", "2026-06-15", "Residual patterns should be inspected, not only summarized."),
        CanvasCard("loss-function", "Loss Function", "objective review", 94, "review", "2026-06-15", "Loss-function choice encodes judgment and should be documented."),
        CanvasCard("identifiability", "Identifiability", "parameter review", 93, "review", "2026-06-15", "Poor identifiability should narrow claims and widen uncertainty."),
        CanvasCard("validation-boundary", "Validation Boundary", "governance", 92, "active", "2026-06-15", "Calibration is not validation."),
    ]

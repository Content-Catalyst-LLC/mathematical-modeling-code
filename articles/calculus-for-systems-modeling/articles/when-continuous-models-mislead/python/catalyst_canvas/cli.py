...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("continuity-assumption", "Continuity Assumption", "model assumption", 96, "active", "2026-06-15", "Smooth mathematical output does not prove smooth system behavior."),
        CanvasCard("threshold-check", "Threshold Check", "regime review", 95, "review", "2026-06-15", "A model without threshold review may understate fragility."),
        CanvasCard("equilibrium-review", "Equilibrium Review", "interpretation review", 94, "review", "2026-06-15", "An equilibrium is a mathematical condition, not a complete interpretation."),
        CanvasCard("solver-diagnostic", "Solver Diagnostic", "numerical governance", 93, "review", "2026-06-15", "A successful solver run does not prove model validity."),
        CanvasCard("claim-boundary", "Claim Boundary", "model governance", 92, "review", "2026-06-15", "Continuous model claims must be tied to scope, evidence, and diagnostics."),
    ]

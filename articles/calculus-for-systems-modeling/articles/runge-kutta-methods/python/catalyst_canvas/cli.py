...
def build_cards() -> list[CanvasCard]:
    return [
        ...
        CanvasCard("rk-stage", "Runge–Kutta Stage", "method", 95, "active", "2026-06-15", "Intermediate slope locations and formulas should be visible."),
        CanvasCard("rk4-update", "RK4 Update", "method", 94, "active", "2026-06-15", "Classical RK4 combines four weighted slope stages."),
        CanvasCard("step-size", "Step Size", "error analysis", 93, "review", "2026-06-15", "Step-size sensitivity should be tested before interpretation."),

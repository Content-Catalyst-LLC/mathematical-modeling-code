...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("surface-definition", "Surface Definition", "boundary", 96, "active", "2026-06-15", "State surface, boundary, parameterization, and interface meaning."),
        CanvasCard("area-element", "Surface Area Element", "geometry", 95, "active", "2026-06-15", "Document actual surface area rather than projected area."),
        CanvasCard("scalar-surface-integral", "Scalar Surface Integral", "accumulation", 95, "active", "2026-06-15", "Document scalar units and accumulated burden meaning."),
        CanvasCard("vector-flux-integral", "Vector Flux Integral", "flux", 96, "active", "2026-06-15", "Document vector units, normal direction, and crossing interpretation."),
        CanvasCard("normal-orientation", "Normal Orientation", "governance", 93, "review", "2026-06-15", "Check normal consistency and whether signs represent inflow or outflow."),
    ]

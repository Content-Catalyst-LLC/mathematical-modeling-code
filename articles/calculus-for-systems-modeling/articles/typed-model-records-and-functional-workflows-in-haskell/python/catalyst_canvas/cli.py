...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("parameter-record", "Parameter Record", "typed governance", 97, "active", "2026-06-15", "Named parameters, units, ranges, and sources should be preserved."),
        CanvasCard("state-record", "State Record", "typed governance", 95, "active", "2026-06-15", "State records should preserve time, units, and stock values."),
        CanvasCard("solver-status", "Solver Status", "diagnostics", 94, "review", "2026-06-15", "Convergence, warning, and failure states should be explicit."),
        CanvasCard("diagnostic-record", "Diagnostic Record", "model review", 93, "active", "2026-06-15", "Diagnostics should remain attached to model outputs."),
        CanvasCard("claim-boundary", "Claim Boundary", "governance", 92, "review", "2026-06-15", "Type safety does not replace empirical evidence or judgment."),
    ]

...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("standard-form", "Standard Form", "model structure", 96, "active", "2026-06-15", "Use dy/dt + p(t)y = q(t) to expose coefficient and forcing assumptions."),
        CanvasCard("integrating-factor", "Integrating Factor", "solution method", 95, "active", "2026-06-15", "Integrating factor documents how proportional terms weight input history."),
        CanvasCard("input-loss-balance", "Input-Loss Balance", "systems interpretation", 94, "active", "2026-06-15", "Input and proportional loss should be measured or justified."),
        CanvasCard("equilibrium-transient", "Equilibrium and Transient", "dynamic interpretation", 93, "review", "2026-06-15", "Separate long-run balance from decaying initial deviation."),
        CanvasCard("linearity-scope", "Linearity Scope", "governance", 92, "review", "2026-06-15", "State where linear approximation is valid and where it fails."),
    ]

...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("state-vector", "State Vector", "model structure", 96, "active", "2026-06-15", "All state variables should be defined with units and domain constraints."),
        CanvasCard("coupling-terms", "Coupling Terms", "interaction structure", 95, "active", "2026-06-15", "Coupling terms should be tied to mechanism, data, or explicit scenario logic."),
        CanvasCard("equilibrium-analysis", "Equilibrium Analysis", "qualitative analysis", 94, "review", "2026-06-15", "Equilibria are conditional on model structure and parameter values."),
        CanvasCard("phase-plane", "Phase Plane", "dynamic interpretation", 93, "active", "2026-06-15", "Phase-plane records reveal state-to-state trajectory structure."),
        CanvasCard("solver-domain-check", "Solver and Domain Check", "governance", 92, "review", "2026-06-15", "Step size, solver method, and domain validity require review."),
    ]

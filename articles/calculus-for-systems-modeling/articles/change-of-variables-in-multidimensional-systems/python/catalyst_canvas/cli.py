...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("transformation-map", "Transformation Map", "formal concept", 96, "active", "2026-06-15", "State original variables, transformed variables, and the explicit mapping."),
        CanvasCard("domain-mapping", "Domain Mapping", "boundary", 95, "active", "2026-06-15", "Document source region, transformed region, coverage, and possible double counting."),
        CanvasCard("jacobian-determinant", "Jacobian Determinant", "geometry", 94, "active", "2026-06-15", "Report determinant formula and where it is zero, negative, or highly variable."),
        CanvasCard("density-conservation", "Density Conservation", "governance", 92, "review", "2026-06-15", "Check that mass, probability, exposure, or burden totals are preserved."),
        CanvasCard("singularity-check", "Singularity Check", "diagnostic", 91, "review", "2026-06-15", "Flag non-invertibility, near-zero determinant, orientation reversal, and domain restrictions."),
    ]

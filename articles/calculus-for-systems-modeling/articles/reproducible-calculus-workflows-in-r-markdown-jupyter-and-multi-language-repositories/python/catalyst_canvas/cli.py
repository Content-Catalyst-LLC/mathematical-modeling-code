...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("r-markdown-report", "R Markdown Report", "executable reporting", 96, "active", "2026-06-15", "Rendered reports should be regenerated from source."),
        CanvasCard("jupyter-notebook", "Jupyter Notebook", "notebook governance", 95, "review", "2026-06-15", "Notebook state can drift; clean reruns are needed."),
        CanvasCard("parameter-record", "Parameter Record", "source record", 94, "active", "2026-06-15", "Parameter records need names, units, sources, and ranges."),
        CanvasCard("output-register", "Output Register", "artifact governance", 93, "active", "2026-06-15", "Generated outputs should be traceable to source scripts."),
        CanvasCard("governance-queue", "Governance Queue", "model review", 92, "review", "2026-06-15", "Governance queues support human review but do not replace it."),
    ]

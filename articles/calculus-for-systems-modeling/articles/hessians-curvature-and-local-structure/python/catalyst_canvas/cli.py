...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("hessian-matrix", "Hessian Matrix", "formal concept", 95, "active", "2026-06-15", "State function, input units, derivative method, and reference point."),
        CanvasCard("second-order-approximation", "Second-Order Approximation", "approximation", 92, "active", "2026-06-15", "Compare first-order and second-order estimates against actual model change."),
        CanvasCard("cross-partials", "Cross Partials", "interaction", 90, "review", "2026-06-15", "Do not treat second-order interaction as causal without model justification."),
        CanvasCard("curvature-classification", "Curvature Classification", "diagnostic", 94, "active", "2026-06-15", "Flag positive definite, negative definite, indefinite, and inconclusive local shape."),
        CanvasCard("conditioning", "Conditioning", "governance", 91, "review", "2026-06-15", "Curvature interpretation depends on scaling, units, and numerical stability."),
    ]

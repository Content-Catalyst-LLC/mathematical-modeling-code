...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("oriented-surface", "Oriented Surface", "geometry", 96, "active", "2026-06-15", "Surface normal defines positive curl-flux direction."),
        CanvasCard("boundary-curve", "Boundary Curve", "geometry", 96, "active", "2026-06-15", "Boundary curve must bound the selected surface."),
        CanvasCard("right-hand-rule", "Right-Hand Rule", "sign convention", 95, "active", "2026-06-15", "Boundary direction and surface normal must be paired consistently."),
        CanvasCard("curl-flux", "Curl Flux", "theorem", 95, "active", "2026-06-15", "Surface curl flux should match boundary circulation."),
        CanvasCard("resolution", "Resolution Review", "numerical method", 92, "review", "2026-06-15", "Boundary and surface estimates should be checked under refinement."),
    ]

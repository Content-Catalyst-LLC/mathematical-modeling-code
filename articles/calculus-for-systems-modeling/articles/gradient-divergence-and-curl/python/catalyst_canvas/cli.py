...
def build_cards() -> list[CanvasCard]:
    return [
        CanvasCard("gradient", "Gradient", "operator", 96, "active", "2026-06-15", "Gradient requires a scalar field, units, coordinates, and derivative method."),
        CanvasCard("divergence", "Divergence", "operator", 95, "active", "2026-06-15", "Divergence requires meaningful vector components and a conservation-aware interpretation."),
        CanvasCard("curl", "Curl", "operator", 95, "active", "2026-06-15", "Curl describes local rotation and should not be overstated as full circulation."),
        CanvasCard("grid-resolution", "Grid Resolution", "numerical method", 92, "review", "2026-06-15", "Finite differences depend on grid spacing, smoothing, interpolation, and boundary handling."),
        CanvasCard("field-meaning", "Field Meaning", "governance", 94, "review", "2026-06-15", "Operator interpretation depends on what the field represents and how it was measured or modeled."),
    ]

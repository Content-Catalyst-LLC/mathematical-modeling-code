...
def build_cards() -> list[CanvasCard]:
    return [
        ...
        CanvasCard("diffusion", "Diffusion", "spatial mechanism", 95, "active", "2026-06-15", "Diffusion should represent plausible spreading, smoothing, or mixing."),
        CanvasCard("transport", "Transport", "spatial mechanism", 94, "review", "2026-06-15", "Velocity magnitude, direction, and units should be documented."),
        CanvasCard("flux", "Flux", "conservation", 93, "review", "2026-06-15", "Flux terms should connect movement, boundary exchange, and accumulation."),
        CanvasCard("spatial-governance", "Spatial Governance", "governance", 92, "active", "2026-06-15", "Boundary, grid, stability, and source assumptions should be recorded."),
    ]

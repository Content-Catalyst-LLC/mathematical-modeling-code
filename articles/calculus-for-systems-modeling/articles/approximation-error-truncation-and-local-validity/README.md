...
Companion code and reproducible workflows for **Approximation Error, Truncation, and Local Validity** in the **Calculus for Systems Modeling** series.

## Themes

- absolute and relative error;
- truncation and omitted terms;
- Taylor remainders;
- local validity;
- numerical error and step size;
- roundoff and discretization;
- error propagation;

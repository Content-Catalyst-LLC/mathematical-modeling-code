# Advanced Mathematical Audit: Domains, Ranges, and the Structure of Functional Models

## Article focus

domains, codomains, images, feasible sets, invariant sets, constraints, and state spaces

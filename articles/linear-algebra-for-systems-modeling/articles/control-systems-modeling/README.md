...
Companion code and reproducible workflows for **“Control Systems Modeling”**.

Status: **planned**.

A treatment of states, inputs, outputs, controllability, observability, and system response.

...
Companion code and reproducible workflows for **“Visualization of Vectors, Transformations, and State Spaces”**.

Status: **planned**.

A workflow article on making linear structure visible.

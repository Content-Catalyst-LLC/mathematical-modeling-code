...
def main() -> None:
    ...
    with (output_dir / "compression_noise_and_informational_tradeoffs_calculator.json").open("w", encoding="utf-8") as handle:
        json.dump(result, handle, indent=2, sort_keys=True)

    with (output_dir / "compression_noise_and_informational_tradeoffs_calculator.csv").open("w", newline="", encoding="utf-8") as handle:

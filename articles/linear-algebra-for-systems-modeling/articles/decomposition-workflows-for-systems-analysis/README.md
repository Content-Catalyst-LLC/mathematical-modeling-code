...
Companion code and reproducible workflows for **“Decomposition Workflows for Systems Analysis”**.

Status: **planned**.

A practical article on PCA, SVD, matrix factorization, exploratory decomposition, and model interpretation.

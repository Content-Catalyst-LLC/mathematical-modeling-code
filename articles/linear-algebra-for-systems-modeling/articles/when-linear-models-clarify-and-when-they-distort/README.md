...
Companion code and reproducible workflows for **“When Linear Models Clarify and When They Distort”**.

Status: **planned**.

A cautionary article on linear simplification, missed nonlinearities, and hidden assumptions.

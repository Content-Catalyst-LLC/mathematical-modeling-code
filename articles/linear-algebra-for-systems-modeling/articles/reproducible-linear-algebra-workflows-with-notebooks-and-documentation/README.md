...
Companion code and reproducible workflows for **“Reproducible Linear Algebra Workflows with Notebooks and Documentation”**.

Status: **planned**.

A workflow article on documentation, code, outputs, metadata, and reproducibility.

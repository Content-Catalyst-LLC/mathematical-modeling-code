...
Companion code and reproducible workflows for **“Orthogonal Decomposition and Structured Approximation”**.

Status: **planned**.

A foundation for breaking systems into interpretable components.

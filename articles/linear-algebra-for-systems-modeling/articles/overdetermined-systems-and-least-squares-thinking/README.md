...
Companion code and reproducible workflows for **“Overdetermined Systems and Least Squares Thinking”**.

Status: **planned**.

A bridge to regression, calibration, approximation, and empirical modeling.

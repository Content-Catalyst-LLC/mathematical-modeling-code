...
def main() -> None:
    ...
    with (output_dir / "optimization_gradients_and_matrix_structure_calculator.json").open("w", encoding="utf-8") as handle:
        json.dump(result, handle, indent=2, sort_keys=True)

    with (output_dir / "optimization_gradients_and_matrix_structure_calculator.csv").open("w", newline="", encoding="utf-8") as handle:

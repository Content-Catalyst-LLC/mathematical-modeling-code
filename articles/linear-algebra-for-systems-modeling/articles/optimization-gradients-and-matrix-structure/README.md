...
Companion code and reproducible workflows for **“Optimization, Gradients, and Matrix Structure”**.

Status: **planned**.

A treatment of matrix-based optimization and system objectives.

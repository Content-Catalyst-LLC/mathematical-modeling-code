...
Companion code and reproducible workflows for **“Incidence Structure and Graph Representation”**.

Status: **planned**.

An article on node-edge relationships, direction, and connectivity.

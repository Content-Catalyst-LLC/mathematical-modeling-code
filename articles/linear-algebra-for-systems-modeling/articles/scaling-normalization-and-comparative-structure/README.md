...
Companion code and reproducible workflows for **“Scaling, Normalization, and Comparative Structure”**.

Status: **planned**.

A treatment of unit differences, scale effects, and comparability.
